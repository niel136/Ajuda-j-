...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "inline-flex items-center justify-center rounded-full font-bold transition-all transform active:scale-95 focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed";
  
  const variants = {
    // Primary is now Black with Green text (High contrast)
    primary: "bg-gray-900 text-[#E2F687] hover:bg-black shadow-lg shadow-gray-900/10",
    // Black variant for specific dark cards
    black: "bg-black text-white hover:bg-gray-800",
    // Secondary is White with Black text
