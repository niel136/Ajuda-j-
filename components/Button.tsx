...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-[#E2F687] text-black shadow-md",
    black: "bg-black text-white shadow-lg shadow-black/10",
  ...
  const sizes = {
    ...
    md: "px-6 py-3 text-sm h-12 rounded-2xl", 
    lg: "px-8 py-4 text-base h-14 rounded-full",
